...
<table class="table" class="table" id="results">
                        <thead >
                          <tr>
                            <th scope="col">N/C</th>
                              ...
                              <th scope="col">Numero de Inmueble</th>
                        ...
                        $sql = "SELECT c.N_C, c.Clave1, c.Clave2, c.Ubicacion, c.Inmueble, c.Nombre_Depto, u.Nombre, c.Direccion, c.Localizacion
                        FROM departamentos c
                        JOIN usuarios u ON c.IdDeptos = u.IdUsuario";
                        ;
