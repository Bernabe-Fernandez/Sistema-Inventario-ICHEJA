...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            INNER JOIN usuarios u ON c.IdCoord = u.IdUsuario
            WHERE c.IdCoord = $id
            ";
                ...
                ?>
                    ...
                    <form class="form" id="FormAdd" action="Crud/UpdateCoor.php?id=<?php echo $id; ?>" method="POST">

                        <div class="container">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="N_c" class="form-label">N/C:</label>
                                    ...
                                    <textarea id="Ubicacion" name="Ubicación"><?php echo $row['Ubicacion']; ?></textarea><br><br>

                                    <label for="No.inmueble" class="form-label">Numero del inmueble:</label>
                                    <input type="number" id="Inmueble" name="Inmueble" value="<?php echo $row['Inmueble']; ?>"><br><br><br>

                                </div>
                                <div class="col-md-6">
                                    <label for="No.dep" class="form-label">Nombre de coordinación:</label>
                                    <input type="text" id="Nombre_Coord" name="Nombre_Coord" value="<?php echo $row['Nombre_Coord']; ?>"><br><br>
                        ...
                        <div style="text-align: center;">
                            <div style="display: inline-block;">
                                ...
                                <button id="cancelCoor" type="button" class="BotonGuardar" style="vertical-align: middle;"><i><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-x-circle-fill" viewBox="0 0 16 16">
            ...
            form.addEventListener('submit', function(event) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        fetch('Crud/UpdateCoor.php?id=<?php echo $id; ?>', {
                            method: 'POST',
                            body: formData
                        }).then(response => {
                            if (response.ok) {
        ...
        <script>
            cancelCoor.addEventListener('click', function() {
                Swal.fire({
