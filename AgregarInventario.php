    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="main col">
                ...
                <form class="form" method="post" action="crud/guardar.php">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="NombreLugar" name="NombreLugar" class="" required><br><br>                                
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" id="NombreUsuario" name="NombreUsuario" class="" required><br><br>
                                ...
                                <input type="text" id="FormaAdqui" name="FormaAdqui" class="" required><br><br>
                                ...
                                <input type="text" id="Observacion" name="Observacion" class="" required><br><br>
                                <label for="ObservacionGral" class="form-label">Observacion General:</label>
                                <input type="text" id="ObservacionGral" name="ObservacionGral" class="" required><br><br>
                                <label for="NumInventarioConsumo" class="form-label">Numero Inventario Consumo:</label>
                                <input type="text" id="NumInventarioConsumo" name="NumInventarioConsumo" class="" required><br><br>
