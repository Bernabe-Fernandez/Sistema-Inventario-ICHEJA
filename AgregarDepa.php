          ...
          <div class="container">
            ...
            <div style="text-align: center;">
              <div style="display: inline-block;">
                ...
                <button id="cancelBtnDepa" type="button" class="BotonGuardar" style="vertical-align: middle;"><i><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-x-circle-fill" viewBox="0 0 16 16">
                    ...
                    if (result.isConfirmed) {
                      ...
                      fetch('crud/InsertarDeptos.php', {
                        ...
                        if (response.ok) {
                          ...
                          setTimeout(function() {
                            window.location.href = 'Departamentos.php'; //modificar para que al momento de guardar me direcciones a usuarios
                          }, 1000);
                        } else {
              ...
              <script>
                cancelBtnDepa.addEventListener('click', function() {
                  Swal.fire({
