    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="main col">
                ...
                <form class="form" method="post" action="crud/update.php?id=<?php echo $id; ?>">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                <label for="No" class="form-label">No:</label>
                                <input type="text" id="No" name="No" class="" value="<?php echo $No; ?>"><br><br>

                                <label for="COG" class="form-label">COG:</label>
                                <input type="text" id="COG" name="COG" class="" value="<?php echo $COG; ?>"><br><br>

                                <label for="NumInvenCompleto" class="form-label">Numero Inventario:</label>
                                <input type="text" id="NumInvenCompleto" name="NumInvenCompleto" class="" value="<?php echo $NumInvenCompleto; ?>"><br><br>

                                <label for="TramiteBajas2023" class="form-label">Tramite Bajas 2023:</label>
                                <input type="text" id="TramiteBajas2023" name="TramiteBajas2023" class="" value="<?php echo $TramiteBajas2023; ?>"><br><br><br>

                                <label for="Estatus" class="form-label">Estatus:</label>
                                <input type="text" id="Estatus" name="Estatus" class="" value="<?php echo $Estatus; ?>"><br><br>

                                <label for="NombreBien" class="form-label">Nombre del Bien:</label>
                                <input type="text" id="NombreBien" name="NombreBien" class="" value="<?php echo $NombreBien; ?>"><br><br>

                                <label for="descripcion">Descripción:</label>
                                <textarea id="descripcion" name="Descripcion" required><?php echo $descripcion; ?></textarea><br><br>

                                <label for="Estado" class="form-label">Estado:</label>
                                <input type="text" id="Estado" name="Estado" class="" value="<?php echo $Estado; ?>"><br><br><br>

                                <label for="Municipio" class="form-label">Municipio:</label>
                                <input type="text" id="Municipio" name="Municipio" class="" value="<?php echo $Municipio; ?>"><br><br><br>

                                <label for="Inmuble" class="form-label">Inmuble:</label>
                                <input type="text" id="Inmuble" name="Inmuble" class="" value="<?php echo $Inmuble; ?>"><br><br><br>

                                <label for="CoordinacionZona" class="form-label">Coordinacion a la que Pertenece:</label>
                                <input type="text" id="CoordinacionZona" name="CoordinacionZona" class="" value="<?php echo $CoordinacionZona; ?>"><br><br>

                                <label for="NombreLugar" class="form-label">Nombre Lugar:</label>
                                <input type="text" id="NombreLugar" name="NombreLugar" class="" value="<?php echo $NombreLugar; ?>"><br><br>

                            </div>
                            <div class="col-md-6">

                                <label for="ClaveUbicacion" class="form-label">Clave Ubicación:</label>
                                <input type="text" id="ClaveUbicacion" name="ClaveUbicacion" class="" value="<?php echo $ClaveUbicacion; ?>" required><br><br>

                                <label for="NombreUsuario" class="form-label">Nombre del Usuario:</label>
                                <input type="text" id="NombreUsuario" name="NombreUsuario" class="" value="<?php echo $NombreUsuario; ?>"><br><br>

                                <label for="NumUsuario" class="form-label">Numero del Usuario:</label>
                                <input type="text" id="NumUsuario" name="NumUsuario" class="" value="<?php echo $NumUsuario; ?>"><br><br>

                                <label for="Costo" class="form-label">Costo</label>
                                <input type="text" id="Costo" name="Costo" class="" value="<?php echo $Costo; ?>"><br><br>

                                <label for="FechaAdqui" class="form-label">Fecha Adquisicion:</label>
                                <input type="text" id="FechaAdqui" name="FechaAdqui" class="" value="<?php echo $FechaAdqui; ?>"><br><br>

                                <label for="FormaAdqui" class="form-label">Forma Adquisicion:</label>
                                <input type="text" id="FormaAdqui" name="FormaAdqui" class="" value="<?php echo $FormaAdqui; ?>"><br><br>

                                <label for="Proveedor" class="form-label">Proveedor</label>
                                <input type="text" id="Proveedor" name="Proveedor" class="" value="<?php echo $Proveedor; ?>"><br><br>

                                <label for="Factura" class="form-label">Factura:</label>
                                <input type="text" id="Factura" name="Factura" class="" value="<?php echo $Factura; ?>"><br><br>

                                <label for="Condiciones" class="form-label">Condiciones:</label>
                                <input type="text" id="Condiciones" name="Condiciones" class="" value="<?php echo $Condiciones; ?>" required><br><br>

                                <label for="Observacion" class="form-label">Observaciones:</label>
                                <input type="text" id="Observacion" name="Observacion" class="" value="<?php echo $Observacion; ?>"><br><br>

                                <label for="ObservacionGral" class="form-label">Observacion General:</label>
                                <input type="text" id="ObservacionGral" name="ObservacionGral" class="" value="<?php echo $ObservacionGral; ?>"><br><br>

                                <label for="NumInventarioConsumo" class="form-label">Numero Inventario Consumo:</label>
                                <input type="text" id="NumInventarioConsumo" name="NumInventarioConsumo" class="" value="<?php echo $NumInventarioConsumo; ?>"><br><br>

                                <label for="Serape" class="form-label">Serape:</label>
                                <input type="text" id="Serape" name="Serape" class="" value="<?php echo $Serape; ?>"><br><br>
                            </div>
                        </div>
