...
$nombre_dep = mysqli_real_escape_string($conn, $_POST['No_dep']);
$direccion = mysqli_real_escape_string($conn, $_POST['Direccion']);
$localizacion = mysqli_real_escape_string($conn, $_POST['Localizacion']);

// Preparar la consulta SQL utilizando parámetros
$stmt = $conn->prepare("INSERT INTO departamentos (IdDeptos, N_C, Clave1, Clave2, Ubicacion, Inmueble, Nombre_Depto, Direccion, Localizacion) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
