...
$columns = ['IdUsuario','No_User', 'Nombre', 'Telefono'];
$columns2 = ['Nombre'];
$contadort1 = 'IdUsuario';
...
if($num_rows > 0){
    while($row = $resultado->fetch_assoc()){
       ...
       $output['data'] .= '<td><a  href="ActualizarUsuario.php?id=' . $row['IdUsuario'] . '"><i class="bi bi-pencil-square"></i></a></td>';
       $output['data'] .= '<td><a class="borrar" href="#" onclick="eliminarUsuario(' . $row['IdUsuario'] . ')"><i class="bi bi-trash3-fill"></i></a></td>';
